...
public class RefineryGui extends SingleStorageGui<RefineryGui, Refinery> {
    ...
    public void loadItems() {
        ...
        setupHandlePutOrTakeStorageStack(13, getStorage(VOLUME_CONTEXT), VOLUME_SLOTS, true, true);
        setupHandlePutOrTakeStorageStack(49, getStorage(FILLED_CONTEXT), FILLED_SLOTS, false, true);
        super.loadItems();
    }
