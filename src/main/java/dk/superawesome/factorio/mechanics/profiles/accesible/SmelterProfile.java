...
public class SmelterProfile implements GuiMechanicProfile<Smelter> {
    ...
    public MechanicLevel.Registry getLevelRegistry() {
        return MechanicLevel.Registry.Builder
                ...
                .setDescription(4, Arrays.asList("§eLager: 22 stacks §f-> §e32 stacks", "§eBrændstof: 20 stacks §f-> §e32 stacks", "§eIngredienser: 24 stacks §f-> §e36 stacks", "§eHastighed: " + ticksToMs(20) + "ms §f-> §e" + ticksToMs(16) + "ms §f(§e"+ getIncreaseDifference(20, 16, true) +"% hurtigere§f)"))
                .setDescription(5, Arrays.asList("§eLager: 32 stacks §f-> §e64 stacks", "§eBrændstof: 32 stacks §f-> §e48 stacks", "§eIngredienser: 36 stacks §f-> §e54 stacks", "§eHastighed: " + ticksToMs(20) + "ms §f-> §e" + ticksToMs(14) + "ms §f(§e"+ getIncreaseDifference(20, 14, true) +"% hurtigere§f)"))
