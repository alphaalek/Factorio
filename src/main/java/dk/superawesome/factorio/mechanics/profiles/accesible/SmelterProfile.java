...
public class SmelterProfile implements GuiMechanicProfile<Smelter> {
    ...
    public MechanicLevel.Registry getLevelRegistry() {
        return MechanicLevel.Registry.Builder
                ...
                .setDescription(3, Arrays.asList("§eLager: 15 stacks §f-> §e22 stacks", "§eBrændstof: 16 stacks §f-> §e24 stacks", "§eIngredienser: 16 stacks §f-> §e24 stacks", "§eHastighed: " + ticksToMs(20) + "ms §f-> §e" + ticksToMs(18) + "ms §f(§e"+ getIncreaseDifference(20, 18, true) +"% hurtigere§f)"))
                .setDescription(4, Arrays.asList("§eLager: 22 stacks §f-> §e32 stacks", "§eBrændstof: 24 stacks §f-> §e36 stacks", "§eIngredienser: 24 stacks §f-> §e36 stacks", "§eHastighed: " + ticksToMs(20) + "ms §f-> §e" + ticksToMs(16) + "ms §f(§e"+ getIncreaseDifference(20, 16, true) +"% hurtigere§f)"))
                .setDescription(5, Arrays.asList("§eLager: 32 stacks §f-> §e64 stacks", "§eBrændstof: 36 stacks §f-> §e54 stacks", "§eIngredienser: 36 stacks §f-> §e54 stacks", "§eHastighed: " + ticksToMs(20) + "ms §f-> §e" + ticksToMs(14) + "ms §f(§e"+ getIncreaseDifference(20, 14, true) +"% hurtigere§f)"))
